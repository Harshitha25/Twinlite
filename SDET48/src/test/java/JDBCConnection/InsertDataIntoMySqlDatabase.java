...
public class InsertDataIntoMySqlDatabase {
	...
	public static void main(String[] args) throws SQLException {
		...
		try {   
		    ...
		    connection = DriverManager.getConnection("jdbc:mysql://localhost:3306/project","root","root");//form a connection with the DB
			Statement statement=connection.createStatement();//create a statement
			String Query="insert into practice values('preetam22','gupta56','1998-05-23','male');";//create a query
